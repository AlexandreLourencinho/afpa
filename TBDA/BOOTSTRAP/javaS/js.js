...
// chek nom regex
    ...
    if(form.prenom.value == "") {
        prenom.setCustomValidity("Le champ est vide!");
        form.prenom.focus();
        return false;
    }
    // check  prenom regex 
    if(!fnom.test(form.prenom.value)) {
        prenom.setCustomValidity("Uniquement des lettres majuscules ou minuscules");
        form.prenom.focus();
        return false;
    }        
        //   check mail vide
    if(form.mail.value == "") {
            mail.setCustomValidity("Le champ est vide!");
            form.mail.focus();
            return false;
    }  
        //   check mail regex
