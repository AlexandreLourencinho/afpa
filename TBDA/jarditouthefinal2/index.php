...
<!-- CONTENU DE LA PAGE -->
<?php //echo $_SERVER['DOCUMENT_ROOT']; echo "<br>";
...
<div class="container-fluid shadow">       
                    ...
                    <!-- div de la colonne droite responsive -->
                      <div class="container border-top rounded-lg mt-sm-6 mt-md-0 shadow col-12 col-md-4 bg-warning">
                          <h4 class="text-center">ZONE DE BLABLA</h4><br>
                          ...
                          <p>Note à moi même : essayer de trouver un truc interessant/rp a mettre ici (pourquoi pas le panier, tiens?)(bah pas eu le temps en fait)</p><br>
